...
while 1,
  ...
  orx(1) = min(orx(1),orx(4));
  orx(4) = min(orx(1),orx(4));
  orx(2) = max(orx(2),orx(3));
  orx(3) = max(orx(2),orx(3));
  ory(1) = min(ory(1),ory(2));
  ory(2) = min(ory(1),ory(2));
  ory(3) = max(ory(3),ory(4));
  ory(4) = max(ory(3),ory(4));
